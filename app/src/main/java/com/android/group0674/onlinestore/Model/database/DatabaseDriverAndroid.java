...
public class DatabaseDriverAndroid extends SQLiteOpenHelper {
  ...
  protected long insertAccountLine(int accountId, int itemId, int quantity) {
    ...
    Log.d("ACTUAL INSERTING PROCSESS ACCOUNT ID, ITEMID, QUANTITY, ",
  ...
  protected String getRole(int id) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT NAME FROM ROLES WHERE ID = ?";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
  ...
  protected int getUserRole(int userId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT ROLEID FROM USERROLE WHERE USERID = ?";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
  ...
  protected Cursor getUsersByRole(int roleId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT USERID FROM USERROLE WHERE ROLEID = ?";
    return sqLiteDatabase.rawQuery(statement,
  ...
  protected String getPassword(int userId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT PASSWORD FROM USERPW WHERE USERID = ?";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
            new String[] {String.valueOf(userId)});
    cursor.moveToFirst();
  ...
  protected int getInventoryQuantity(int itemId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT QUANTITY FROM INVENTORY WHERE ITEMID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
            new String[]{String.valueOf(itemId)});
    cursor.moveToFirst();
  ...
  protected Cursor getSaleById(int saleId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT * FROM SALES WHERE ID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
  ...
  protected Cursor getSalesToUser(int userId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT * FROM SALES WHERE USERID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
            new String[] {String.valueOf(userId)});
    return cursor;
  }
  ...
  protected Cursor getItemizedSaleById(int saleId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT * FROM ITEMIZEDSALES WHERE SALEID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
            new String[] {String.valueOf(saleId)});
    return cursor;
  }
  ...
  protected Cursor getUserAccounts(int userId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    Log.d("THE ID THAT IS PASSED IN GETUSERACCOUTNS IS", Integer.toString(userId));
    String statement = "SELECT ID FROM ACCOUNT WHERE USERID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
            new String[] {String.valueOf(userId)});
    Log.d("THE CURSOR IS NULL IN THE DATABASEANDRODRIVER", Boolean.toString(cursor==null));
    return cursor;
  }

  protected Cursor getAccountDetails(int accountId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT * FROM ACCOUNTSUMMARY WHERE ACCTID = ?;";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
  ...
  protected Cursor getUserActiveAccounts(int userId) {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    String statement = "SELECT * FROM ACCOUNT WHERE userId = ? and ACTIVE = ?";
    Cursor cursor = sqLiteDatabase.rawQuery(statement,
